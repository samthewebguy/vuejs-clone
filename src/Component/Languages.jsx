...
const language = [
  ...
  return (
    <div
      className="relative flex items-center gap-2 border-l border-r border-[#5454547a] pl-3 pr-3 ml-6"
    ...
    >
      <img
        src={LanguageIcon}
        alt="Language"
        className="w-5 h-5 cursor-pointer hover:opacity-80 transition hidden md:flex"
      />

      {activeDropdown && (
        <div className="absolute top-5 right-0 bg-[#1a1a1a] text-white rounded-md shadow-lg py-2 w-50 z-10 border border-[#5454547a]">
